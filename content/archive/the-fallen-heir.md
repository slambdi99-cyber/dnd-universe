...
name: The Dissenters
kind: archive
summary: The Dissenters are a grassroots resistance movement against Lorithal's current
  royalty.
...
Canonical label: The Dissenters. Use this name instead of The Rebellion in public-facing MCP pages.

## Superseded

Replaced by `faction/the-dissenters` on 2026-08-14. This page was slugged `the-fallen-heir` after the movement's battle cry rather than its name; "For the Fallen Heir!" is a slogan, not a faction. Kept because the wiki has no delete tool; do not edit.
