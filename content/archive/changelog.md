...
Every write made to this wiki through an assistant, newest entries appended at the bottom.

Each line records the page, what happened to it, who the connection belonged to, and when. This log is written by the client doing the saving, so it covers assistant edits only: changes made directly on the website do not appear here.
