...
name: Abyssal Brood
kind: faction
summary: A tribe of blue kobolds in the cave systems around the Everpool, worshipping
  Broodmaster Goluub and hostile to anyone who enters their territory.
appearance: blue-scaled kobolds, lead chain collars, crude smelted ore tools, wet
  cave stone, pale light off a deep pool
tags:
- faction
- from-dm-compendium
- non-primary-faction
...
- place/copper-ridge
sources:
- 'DM compendium: Lore/Groups/Abyssal Brood.md'
- written by The DM
